...
//
//    @Override
//    public ShopItemFirstDTO findItem(Long shopItemId) {      // 관리자 페이지 상세 정보
//
//        ShopItem shopItem = shopItemRepository.findById(shopItemId)
//                .orElseThrow(() -> new ItemNotFoundException("해당 상품 정보가 존재하지않습니다"));
//
//        ShopItemFirstDTO shopItemFirstDTO = entityToDTOTemp(shopItem);
//
//        log.error("findItem()~~~");
//        log.error(shopItemFirstDTO);
//        log.error(shopItemFirstDTO.getClass());
//        return shopItemFirstDTO;
//    }
//
//    @Override
//    public ShopItemSecondDTO findItemTemp(Long shopItemId) {   // 악세서리 샵 상세 정보
//
//        ShopItem shopItem = shopItemRepository.findById(shopItemId)
//                .orElseThrow(() -> new ItemNotFoundException("해당 상품 정보가 존재하지않습니다"));
//
//        ShopItemSecondDTO shopItemSecondDTO = entityToDTOTemp(shopItem);
//
//
//        if(shopItemSecondDTO.getFileNames().size() == 0){
//            shopItemSecondDTO.addImage("0000", "default.png", 0);
//        }
//
//        shopItemSecondDTO.setItemSellStatus(shopItem.getStockCount() <= 0 ?
//                ItemSellingStatus.STATUS_SOLDOUT : ItemSellingStatus.STATUS_SELLING);
//        shopItemSecondDTO.setItemDetail("상세 설명~~~ ");
//
//        return shopItemSecondDTO;
//    }
//
//    @Override
...
//    }
//
//    private static ShopItemSecondDTO entityToDTOTemp(ShopItem shopItem) {  // 악세서리 샵
//        ShopItemSecondDTO shopItemResDTO = ShopItemSecondDTO.builder()
//                .shopItemId(shopItem.getShopItemId())
//                .itemName(shopItem.getItemName())
//                .originalPrice(shopItem.getItemPrice().getOriginalPrice())
//                .stockCount(shopItem.getStockCount())
